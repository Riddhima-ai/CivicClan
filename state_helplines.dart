...
// Must mirror the `_displayNames` list used on the map page.
...
// Page
// ---------------------------------------------------------------------------
class StateHelplinesPage extends StatelessWidget {
  final String stateName;

  const StateHelplinesPage({super.key, required this.stateName});
